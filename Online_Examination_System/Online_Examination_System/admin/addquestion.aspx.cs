...
public partial class Admin_addquestion : System.Web.UI.Page
{
    ...
    /// <param name="dbcs">the connection string to connect to the
    ...
    ///<sammary>
    ///This is method for adding the question having exam id
    ///<c>protected void btn_addquestion_Click(object sender, EventArgs e)</c> 
    ///<remarks>Main part of this method is @param spAdminRegisterinsert </remarks>
    /// </sammary>
