...
<asp:Content ID="Content2" ContentPlaceHolderID="maincontentplaceholder" runat="Server">
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="card-body">
                <p>In this project, I am going to make an online exam system where an admin can take exam for the current student who are logged in this system. Here, the admin will take the exam of objective type questions.</p>
                ...
                <ul>
                    ...
                    <li>An admin can reset his/her password</li>
                </ul>
